...
import com.iqdep.dataflow.builder.DataflowBuilder;
import com.iqdep.dataflow.edges.Edge;
import com.iqdep.dataflow.edges.EdgeList;
...
public abstract class AbstractVertex<T> implements Serializable {
	...
	public SparkSql map(String sql, int p) {
		SparkSql map1 = new SparkSql(sql);
		map1.addParent(this);
		map1.type = VertexType.POINT_WISE;
		map1.setNbrOfPartitions(p);
		return map1;
